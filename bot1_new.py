                    ...
                    if msg.lower() == 'стоп' or msg.lower() == 'сброс':
                        ...
                        if step == 0:
                            ...
                            if flag == 1:
                                ...
                                send_media(id, 'photo-201924345_457239027', f'Ты наконец добрался до оазиса и обнаруживаешь, что у тебя с собой осталась только - {otvet1},\n\n{otvet1} - Твоя истинная ценность в жизни...', key_null)
